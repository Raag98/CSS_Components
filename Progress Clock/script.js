// www.codewithrandom.com/2021/12/clock-progress-bar-style-clock-using.html

https: window.addEventListener("DOMContentLoaded", () => {
      ...
      units.forEach((u) => {
        ...
        if (ring) {
          ...
          if (strokeDashArray) {
            ...
            ring.setAttribute(
              "stroke-dashoffset",
              circumference * strokeDashOffsetPct
            );
